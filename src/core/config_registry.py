...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "TUSHARE_PROXY_URL": {
        ...
        "description": "Optional proxy endpoint for Tushare-compatible requests.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "TUSHARE_PROXY_TOKEN": {
        "title": "Tushare Proxy Token",
        "description": "Token used when calling the configured Tushare proxy endpoint.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "TUSHARE_TOKEN": {
        "title": "Tushare Fallback Token",
        "description": "Official Tushare Pro token used directly or as fallback when proxy requests fail.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
