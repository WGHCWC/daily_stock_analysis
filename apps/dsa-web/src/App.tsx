...
const StocksIcon: React.FC<{ active?: boolean }> = ({active}) => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={active ? 2 : 1.5}
              d="M4 6h16M4 12h16M4 18h10"/>
        <circle cx="18" cy="18" r="2" fill={active ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={1.5} />
    </svg>
);
...
const LogsIcon: React.FC<{ active?: boolean }> = ({active}) => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
            ...
            d="M9 12h6m-6 4h6M7 4h10a2 2 0 012 2v12a2 2 0 01-2 2H7a2 2 0 01-2-2V6a2 2 0 012-2zM9 4v3m6-3v3"
        />
    </svg>
);
